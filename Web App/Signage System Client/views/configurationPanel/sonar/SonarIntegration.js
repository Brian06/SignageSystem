...
class SonarIntegration extends React.Component {

  constructor(props){
    super(props);
    this.state = { username: '', password: '', site: '', token: '', account: '' };
    ...
    this.setData = () => {
          ...
          axios
          .get(" http://localhost:3000/panel/sonardata")
          .then(res => {
  ...
  saveData(e){
    e.preventDefault();
    axios.post(' http://localhost:3000/panel/sonardata', {
  ...
  render() {
    const nombre = (<h1 style={projectNameStyles}>Sonarqube Integration</h1>);
    return (
      <div>
          ...
          <div className="well" style={wellStyles}>
            <form>
              ...
              <FormGroup>
                ...
                <FormControl type="text" placeholder="Account ID" name="account" value={this.state.account} onChange={this.onChange}/>
              </FormGroup>
              <FormGroup>
